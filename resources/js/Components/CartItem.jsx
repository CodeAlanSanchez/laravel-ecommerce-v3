...
export default function ({item}) {
    ...
    return (
        <div
            className="flex gap-4 flex-initial border-x-0 border-t-0 border-b-2 last:border-none border-gray-200 py-4 w-full">
            <img className="aspect-square w-48 object-cover" src={`/storage/${item.product.image_url}`} alt=""/>
            <div className="w-full">
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => handleAmountChange(e)} type="text" name="amount"
                        value={amount}
                        list="amountOptions"/>
            ...
            <div className="float-right">
                <h3 className="text-lg text-red-700">${item.product.price / 100}</h3>
            </div>
        </div>
    );
}
